...
# data
dataset = './data/cosmopedia-100k-v4'  #V2 BPE, V3 BERT
...
max_iters = 2201  # total number of training iterations
weight_decay = 1e-1
beta1 = 0.9
beta2 = 0.95
...
lr_decay_iters = 2201  # should be ~= max_iters per Chinchilla
